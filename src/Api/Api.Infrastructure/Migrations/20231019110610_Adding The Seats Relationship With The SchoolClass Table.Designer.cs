...
namespace Api.Infrastructure.Migrations
{
    ...
    [Migration("20231019110610_Adding The Seats Relationship With The SchoolClass Table")]
    partial class AddingTheSeatsRelationshipWithTheSchoolClassTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.SchoolAggregate.Entities.Seat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Api.Domain.SchoolAggregate.Entities.Seat", b =>
                {
                    b.HasOne("Api.Domain.SchoolAggregate.Entities.SchoolClass", "Class")
                        .WithMany("Seats")
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Api.Domain.SchoolAggregate.Entities.Student", "Student")
                        .WithMany("Seats")
